...
export default class PositionedCharacter {
   ...
   */
  breakdownIntoCoordinates(position, boardSize) {
  ...
  canAttack(targetPosition, boardSize) {
    ...
    const thisCoordinates = this.breakdownIntoCoordinates(this.position, boardSize);
    const targetCoordinates = this.breakdownIntoCoordinates(targetPosition, boardSize);
  ...
  generateMoveableCells(positionedCharacters, boardSize) {
    ...
    const { x, y } = this.breakdownIntoCoordinates(this.position, boardSize);
